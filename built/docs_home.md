...
Documentation for RAC version: `1.2.0-dev`
...
```
npm install ruler-and-compass@1.2.0-dev
```
...
```
<script src="https://unpkg.com/ruler-and-compass@1.2.0-dev"></script>
```
...
```
requirejs(["https://unpkg.com/ruler-and-compass@1.2.0-dev"], Rac => { ... })
```
